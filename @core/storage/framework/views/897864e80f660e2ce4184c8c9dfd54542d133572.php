...
<![endif]-->
    ...
    <script>
        function iFrameFilterInSummernote(contents) {
            ...
            return rawContents.replace(/<iframe(.+)<\/iframe>/, '{iframe} {vsrc}="' + ifameSrc.replace('src="', '') +
                '{/iframe}');
...
<?php /**PATH C:\Users\user\.projects\Web\swiftpassglobalimmigration-main\swiftpassglobalimmigration-main\@core\resources\views/backend/admin-master.blade.php ENDPATH**/ ?>