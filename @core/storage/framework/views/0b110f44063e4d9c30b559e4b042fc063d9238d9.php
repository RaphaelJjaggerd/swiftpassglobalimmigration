                        ...
                        <form action="<?php echo e(route('admin.price.plan')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="payment_type" id="payment_type" class="form-control">
                                    ...
                                    <option value="phased"><?php echo e(__('Phased')); ?></option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="features"><?php echo e(__('Features')); ?></label>
                                <textarea class="form-control" id="features" name="features" placeholder="<?php echo e(__('Features')); ?>" cols="30"
                                    rows="10"></textarea>
                            ...
                            <button type="submit"
                                class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Price Plan')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.price_plan_edit_btn', function() {
                ...
                form.find('#edit_payment_type option[value="' + el.data('payment_type') + '"]').attr(
                    'selected',
                    true);
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassglobalimmigration\@core\resources\views/backend/pages/price-plan/price-plan-new.blade.php ENDPATH**/ ?>