<section class="footer">
    ...
    <div class="bottom-footer">
        <div class="conatiner">
            <p>© Copyright 2024 SwiftPass Global Hub</p> <br>
            <a href="http://">
                <h6>Developed by Raphael Jjaggerd </h6>
            </a>
        </div><!-- container -->
    </div><!--bottom-footer-->
</section><!--footer-->
<div class="mobile-nav-wrapper">
    ...
    <div class="mobile-nav-content">
        ...
        <div class="logo-box">
            <a href="index.html"><img src="assets/image/logo-light.png" width="160" height="40"
                    alt="26"></a>
        </div><!-- logo-box -->
...
<?php /**PATH C:\Users\user\.projects\Web\nexelit-v3.5.3\@core\resources\views/frontend/partials/custom/footer.blade.php ENDPATH**/ ?>