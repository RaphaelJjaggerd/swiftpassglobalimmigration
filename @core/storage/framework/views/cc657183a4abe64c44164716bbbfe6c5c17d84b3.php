<?php $__env->startSection('page-title'); ?>
    ...
    <?php echo e(__('Payment Success For:')); ?> <?php echo e($booking->appointment ? optional(optional($booking->appointment)->lang)->title : __('Untitled')); ?>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    ...
                    <ul class="booking_details_list">
                        ...
                        <li><strong><?php echo e(__('Payment Gateway')); ?></strong> : <?php echo e(__(str_replace('_',' ',$booking->payment_gateway))); ?></li>
                        <li><strong><?php echo e(__('Payment Status')); ?></strong> : <?php echo e(__($booking->payment_status)); ?></li>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassimmigration\@core\resources\views/frontend/pages/appointment/payment-success.blade.php ENDPATH**/ ?>