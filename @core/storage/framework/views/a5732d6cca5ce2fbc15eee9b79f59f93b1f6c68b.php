                ...
                <div class="col-lg-6">
                    <div class="order-content-area">
                        <h3 class="order-title">
                            <?php echo e(get_static_option('order_page_' . $user_select_lang_slug . '_form_title')); ?>
                                ...
                                <div class="nav nav-tabs" role="tablist">
                                    <?php if(!auth()->check()): ?>
                                        <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                            href="#nav-home" role="tab" aria-selected="true"><i
                                                class="fas fa-user"></i></a>
                                    <?php endif; ?>
                                    <a class="nav-item nav-link  <?php if(auth()->check()): ?> active <?php else: ?> disabled <?php endif; ?>"
                                        disabled id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab"
                                ...
                                <?php if(!auth()->check()): ?>
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                                        <?php if(get_static_option('disable_guest_mode_for_package_module')): ?>
                                            <div
                                                class="checkout-type margin-bottom-30  <?php if(auth()->check()): ?> d-none <?php endif; ?>">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" id="guest_logout"
                                                        name="checkout_type">
                                                    <label class="custom-control-label"
                                                        for="guest_logout"><?php echo e(__('Guest Order')); ?></label>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        <?php if(!auth()->check()): ?>
                                                ...
                                                <form action="<?php echo e(route('user.login')); ?>" method="post"
                                                    ...
                                                    <div class="row mb-4 rmber-area">
                                                        ...
                                                        <div class="col-6 text-right">
                                                            <a class="d-block"
                                                                href="<?php echo e(route('user.register')); ?>"><?php echo e(__('Create new account?')); ?></a>
                                                            <a
                                                                href="<?php echo e(route('user.forget.password')); ?>"><?php echo e(__('Forgot Password?')); ?></a>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <?php if(!auth()->check()): ?>
                                            <div class="next-step">
                                                <button class="next-step-btn btn-boxed d-none"
                                                    type="button"><?php echo e(__('Next Step')); ?></button>
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                                <div class="tab-pane fade <?php if(auth()->check()): ?> show active <?php endif; ?>"
                                    id="nav-profile" role="tabpanel">
                                    <form action="<?php echo e(route('frontend.order.message')); ?>" method="post"
                                        enctype="multipart/form-data" class="contact-form order-form">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <button class="submit-btn width-200"
                        ...
                        <div class="single-price-plan-01 style-02 active">
                            <div class="price-header">
                                ...
                                <div class="price-wrap">
                                    <span class="price"><?php echo e(amount_with_currency_symbol($order_details->price)); ?></span>
                            ...
                            <div class="btn-wrapper text-center">
                                <?php if(!empty($order_details->url_status)): ?>
                                    <a class="order-btn boxed-btn"
                                        href="<?php echo e(route('frontend.plan.order', $order_details->id)); ?>"><span
                                            class="order-btn-text"><?php echo e($order_details->btn_text); ?></span> </a>
                                <?php else: ?>
                                    <a class="order-btn boxed-btn"
                                        href="<?php echo e($order_details->btn_url); ?>"><?php echo e($order_details->btn_text); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassimmigration\@core\resources\views/frontend/pages/package/order-page.blade.php ENDPATH**/ ?>