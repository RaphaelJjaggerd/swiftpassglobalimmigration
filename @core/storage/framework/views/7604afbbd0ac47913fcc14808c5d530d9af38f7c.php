...
<?php endif; ?>
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title"><?php echo e(__('All Package Coupon')); ?></h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if('publish' == $data->status): ?>
                                                    <span
                                                        class="btn btn-success btn-xs"><?php echo e(ucfirst($data->status)); ?></span>
                                                <?php else: ?>
                                                    <span
                                                        class="btn btn-warning btn-xs"><?php echo e(ucfirst($data->status)); ?></span>
                                                <?php endif; ?>
                                            </td>
                                            <!-- -->
                                            <td>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.courses.coupon.delete', $data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                <a href="#" data-toggle="modal" data-target="#category_edit_modal"
                                                    ...
                                                    data-id="<?php echo e($data->id); ?>" data-code="<?php echo e($data->code); ?>"
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.price.plan.coupon.store')); ?>" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control datepicker" id="expire_date" name="expire_date"
                                    placeholder="<?php echo e(__('Expire Date')); ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit"
                                class="btn btn-primary mt-4 pr-4 pl-4"><?php echo e(__('Add New Coupon')); ?></button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="category_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('admin.price.plan.coupon.update')); ?>" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control datepicker" name="expire_date"
                                placeholder="<?php echo e(__('Expire Date')); ?>">
                        </div>
                        <div class="form-group">
...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo $__env->make('backend.partials.bulk-action', ['action' => route('admin.price.plan.coupon.bulk.action')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.category_edit_btn', function() {
                ...
                modal.find('select[name="discount_type"] option[value="' + el.data('discount_type') + '"]')
                    .prop('selected', true);
            });
        });
    </script>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassimmigration\@core\resources\views/backend/pages/price-plan/price-plan-coupon.blade.php ENDPATH**/ ?>