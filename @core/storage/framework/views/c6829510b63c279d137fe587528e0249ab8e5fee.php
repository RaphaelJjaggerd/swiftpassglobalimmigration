                        ...
                        <div class="bulk-delete-wrapper">
                         ...
                         <div class="table-wrap table-responsive">
                            <table class="table table-default" >
                                ...
                                <th><?php echo e(__('Booking Dates')); ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <ul class="time_slot max-width-200">
                                            <?php $__currentLoopData = $data->bookingDates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bookingDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li> <?php echo e($bookingDate->date); ?></li>
                                            <?php if(!$loop->last): ?>
                                             <br>
                                             <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassglobalimmigration\@core\resources\views/backend/appointment/appointment-all.blade.php ENDPATH**/ ?>