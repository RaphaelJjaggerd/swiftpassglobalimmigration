            ...
            <nav id="main_menu_wrap">
                <ul class="metismenu" id="menu">
                    ...
                    <?php if(check_page_permission_by_string('Price Plan')): ?>
                        <li
                            class="main_dropdown <?php echo e(active_menu('admin-home/price-plan')); ?>
                    ...
                    <?php if(check_page_permission_by_string('Brand Logos')): ?>
                        <li class="main_dropdown <?php echo e(active_menu('admin-home/brands')); ?>">
                            <a href="<?php echo e(route('admin.brands')); ?>" aria-expanded="true"><i
                    ...
                    <?php if(check_page_permission_by_string('Package Orders Manage')): ?>
                        <li
                            class="main_dropdown <?php if(request()->is(['admin-home/payment-logs/report', 'admin-home/payment-logs', 'admin-home/package/*'])): ?> active <?php endif; ?>
                                        ">
                            ...
                            <ul class="collapse">
                                ...
                                <li class="<?php echo e(active_menu('admin-home/package/order-page')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.package.order.page')); ?>"><?php echo e(__('Order Page Manage')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/package/order-report')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.package.order.report')); ?>"><?php echo e(__('Order Report')); ?></a>
                                </li>
                        ...
                        <li class="main_dropdown <?php if(request()->is('admin-home/appointment/*')): ?> active <?php endif; ?> ">
                            ...
                            <ul class="collapse">
                                ...
                                <li class="<?php echo e(active_menu('admin-home/appointment/category')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.category.all')); ?>"><?php echo e(__('Category')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/appointment/booking-time')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.booking.time.all')); ?>"><?php echo e(__('Booking Time')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/appointment/booking')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.booking.all')); ?>"><?php echo e(__('All Appointment Booking')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/appointment/review')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.review.all')); ?>"><?php echo e(__('All Reviews')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/appointment/form-builder')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.booking.form.builder')); ?>"><?php echo e(__('Booking Form Builder')); ?></a>
                                </li>
                                <li class="<?php echo e(active_menu('admin-home/appointment/settings')); ?>">
                                    <a
                                        href="<?php echo e(route('admin.appointment.booking.settings')); ?>"><?php echo e(__('Settings')); ?></a>
                                </li>
                            </ul>
                        </li>
                    <?php endif; ?>
                                    ...
                                    <ul class="collapse">
                                        ...
                                        <?php if(empty(get_static_option('home_page_page_builder_status'))): ?>
                                            <?php if(in_array($home_page_variant, ['01', '02', '03', '04'])): ?>
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-page-01/service-area')); ?>">
                                                    <a
                                                ...
                                                <?php if($home_page_variant == '03'): ?>
                                                    <li
                                                        class="<?php echo e(active_menu('admin-home/home-page-01/cta-area')); ?>">
                                                        <a
                                                ...
                                                <li
                                                    class="<?php echo e(active_menu('admin-home/home-page-01/contact-area')); ?>">
                    ...
                    ">
                        ...
                        <ul class="collapse ">
                            ...
                            <?php if(check_page_permission_by_string('Home Variant')): ?>
                                <li
                                    class="<?php echo e(active_menu('admin-home/appearance-setting/navbar-variant/settings')); ?>">
...
<?php /**PATH C:\Users\user\.projects\Web\swiftpassglobalimmigration-main\swiftpassglobalimmigration-main\@core\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>