                              ...
                              <div class="tab-pane fade <?php if(auth()->guard('web')->check()): ?> show active <?php endif; ?>" id="nav-profile" role="tabpanel">
                                ...
                                <form action="<?php echo e(route('frontend.appointment.booking')); ?>" method="post" class="appointment-booking-form" id="appointment-booking-form" enctype="multipart/form-data">
                                  ...
                                  <div class="button-wrap">
                                    <button type="submit" class="btn-boxed btn-color appointment appo_booking_btn"><?php echo e(get_static_option('appointment_single_' . $user_select_lang_slug . '_appointment_booking_button_text')); ?>
...
<?php $__env->startSection('scripts'); ?>
  ...
  <script type="text/javascript" src="<?php echo e(asset('assets-custom/js/evo-calendar.js')); ?>"></script>
