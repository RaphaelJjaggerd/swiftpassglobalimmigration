...
<body>
    <div id="notfound">
        <div class="notfound">
            ...
            <a
                href="<?php echo e(route('homepage')); ?>"><?php echo e(get_static_option('error_404_page_' . get_user_lang() . '_button_text')); ?></a>
        </div>
    </div>
</body>

</html>
<?php /**PATH C:\Users\user\.projects\Web\swiftpassimmigration\@core\resources\views/frontend/pages/newsletter-success.blade.php ENDPATH**/ ?>