...
<?php $__env->startSection('site-title'); ?>
    <?php echo e(__('All Application Stage Orders')); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                                    <h4 class="header-title"><?php echo e(__('All Application Stage Orders')); ?></h4>
                                        ...
                                        <table id="all_user_table" >
                                            ...
                                            <?php $__currentLoopData = $all_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route('admin.package.order.manage.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                        ...
                                                        <?php if(!empty(optional($data->paymentlog)->manual_payment_attachment)): ?>
                                                            <a class="btn btn-success btn-xs my-2" href="<?php echo e(url('assets/uploads/attachment/'.optional($data->paymentlog)->manual_payment_attachment) ?? ''); ?>" target="_blank"><?php echo e(__('View Attachment')); ?></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="order_status" class="form-control" id="order_status">
                               <option value="documentation_and_review"><?php echo e(__('Documentation & Review')); ?></option>
                                <option value="application"><?php echo e(__('Appication')); ?></option>
                                <option value="review_and_submission"><?php echo e(__('Review & Submission')); ?></option>
                                <option value="interviews_and_simulation"><?php echo e(__('Interviews & Simulation')); ?></option>
                                <option value="review_and_submission"><?php echo e(__('Review & Submission')); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\user\.projects\Web\swiftpassglobalimmigration\@core\resources\views/backend/package-order-manage/order-manage-application.blade.php ENDPATH**/ ?>