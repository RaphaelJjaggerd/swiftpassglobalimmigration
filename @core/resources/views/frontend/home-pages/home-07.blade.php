...
<div class="header-slider-one global-carousel-init logistic-dots" data-loop="true" data-desktopitem="1"
            ...
            <div class="row">
                    ...
                    <div class="left-content-wrap">
                        ...
                        <div class="vertical-image">
                            {!! render_image_markup_by_attachment_id(
                                filter_static_option_value('industry_about_section_left_image', $static_field_data),
                                '',
                                'full',
                            ) !!}
                        </div>
                        <div class="industry-video-wrap">
                            {!! render_image_markup_by_attachment_id(
                                filter_static_option_value('industry_about_section_video_background_image', $static_field_data),
                                '',
                                'full',
                            ) !!}
                            <div class="hover">
                ...
                <div class="col-lg-6">
                    <div class="right-content-area margin-top-40">
                        ...
                        <div class="description">{!! filter_static_option_value(
                            'industry_about_section_' . $user_select_lang_slug . '_description',
                            $static_field_data,
                        ) !!}</div>
                        <div class="btn-wrapper">
                            <a href="{{ filter_static_option_value('industry_about_section_button_one_url', $static_field_data) }}"
                                ...
                                <i
                                    class="{{ filter_static_option_value('industry_about_section_button_one_icon', $static_field_data) }}"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title desktop-center margin-bottom-60 industry-home">
                        <span
                            class="subtitle">{{ filter_static_option_value('industry_what_we_offer_section_' . $user_select_lang_slug . '_subtitle', $static_field_data) }}</span>
                        <h2 class="title">
...
@if (!empty(filter_static_option_value('home_page_counterup_section_status', $static_field_data)))
    <div class="industry-counterup-area bg-overlay padding-top-115 padding-bottom-115" {!! render_background_image_markup_by_attachment_id(
        filter_static_option_value('industry_counterup_section_background_image', $static_field_data),
    ) !!}>
        <div class="container">
            <div class="row">
...
@if (!empty(filter_static_option_value('home_page_case_study_section_status', $static_field_data)))
    <div class="industry-project-area padding-top-115 padding-bottom-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <div class="section-title margin-bottom-60 industry-home">
                        <span
                            class="subtitle">{{ filter_static_option_value('industry_project_section_' . $user_select_lang_slug . '_subtitle', $static_field_data) }}</span>
                        <h2 class="title">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="global-carousel-init logistic-dots" data-loop="true" data-desktopitem="2"
                                    ...
                                    <div class="content">
                                        <div class="cat">
                                            ...
                                            @foreach ($category_list as $cat_id => $cat_name)
                                                <a
                                                    href="{{ route('frontend.works.category', ['id' => $cat_id, 'any' => Str::slug($cat_name)]) }}">{{ $cat_name }}</a>
                                            @endforeach
                                        </div>
