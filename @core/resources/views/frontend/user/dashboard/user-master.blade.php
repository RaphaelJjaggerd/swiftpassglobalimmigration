                ...
                <div class="col-lg-12">
                    ...
                    <div class="user-dashboard-wrapper">
                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link @if (request()->routeIs('user.home.package.order')) active @endif"
                                    href="{{ route('user.home.package.order') }}">{{ __('Service Plans') }}</a>
                            </li>
                            {{-- @if (!empty(get_static_option('product_module_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->routeIs('user.home.product.order')) active @endif"
                                        href="{{ route('user.home.product.order') }}">{{ get_static_option('product_page_' . $user_select_lang_slug . '_name') }}
                                        {{ __('Orders') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->routeIs('user.home.product.download')) active @endif"
                                        href="{{ route('user.home.product.download') }}">{{ get_static_option('product_page_' . $user_select_lang_slug . '_name') }}
                                        {{ __('Downloads') }}</a>
                                </li>
                            @endif --}}
                            ...
                            {{-- @if (!empty(get_static_option('donations_module_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->routeIs('user.home.donations')) active @endif"
                                        href="{{ route('user.home.donations') }}">{{ __('All ') }}
                                        {{ get_static_option('donation_page_' . $user_select_lang_slug . '_name') }}</a>
                                </li>
                            @endif --}}
                            @if (!empty(get_static_option('appointment_module_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->routeIs('user.home.appointment.booking')) active @endif"
                                        href="{{ route('user.home.appointment.booking') }}">{{ __('Booked') }}
                                        {{ get_static_option('appointment_page_' . $user_select_lang_slug . '_name') }}s</a>
                                </li>
                            @endif
                            ...
                            {{-- @if (!empty(get_static_option('support_ticket_module_status')))
                                <li class="nav-item">
                                    <a class="nav-link @if (request()->routeIs('user.home.support.tickets')) active @endif"
                                        href="{{ route('user.home.support.tickets') }}">{{ __('All') }}
                                        {{ get_static_option('support_ticket_page_' . $user_select_lang_slug . '_name') }}</a>
                                </li>
                            @endif --}}
                            <li class="nav-item">
...
@section('scripts')
    <script>
        $(document).ready(function() {
            $('select[name="country"] option[value="{{ auth()->guard('web')->user()->country }}"]').attr(
                'selected', true);
        });
    </script>
@endsection
