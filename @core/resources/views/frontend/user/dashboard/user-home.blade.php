        ...
        @if (!empty(get_static_option('product_module_status')))
            <div class="col-lg-6">
                <div class="user-dashboard-card">
                    ...
                    <div class="content">
                        <h4 class="title">{{ get_static_option('product_page_' . $user_select_lang_slug . '_name') }}
                            {{ __('Order') }}</h4>
        ...
        @if (get_static_option('donations_module_status'))
            <div class="col-lg-6">
                <div class="user-dashboard-card style-01">
                    ...
                    <div class="content">
                        <h4 class="title">{{ __('Total') }}
                            {{ get_static_option('donation_page_' . $user_select_lang_slug . '_name') }}</h4>
        ...
        @if (get_static_option('appointment_module_status'))
            <div class="col-lg-6">
                <div class="user-dashboard-card">
                    ...
                    <div class="content">
                        <h4 class="title">{{ get_static_option('appointment_page_' . $user_select_lang_slug . '_name') }}
                            {{ __('Booking') }}</h4>
        ...
        {{-- @if (get_static_option('course_module_status'))
            <div class="col-lg-6">
                <div class="user-dashboard-card style-01">
                    <div class="icon"><i class="fas fa-calendar"></i></div>
                    <div class="content">
                        <h4 class="title">{{ get_static_option('courses_page_' . $user_select_lang_slug . '_name') }}
                            {{ __('Enrolled') }}</h4>
        ...
        @if (get_static_option('support_ticket_module_status'))
            <div class="col-lg-6">
                <div class="user-dashboard-card style-01">
                    <div class="icon"><i class="fas fa-calendar"></i></div>
                    <div class="content">
                        <h4 class="title">{{ __('All') }}
                            {{ get_static_option('support_ticket_page_' . $user_select_lang_slug . '_name') }}</h4>
