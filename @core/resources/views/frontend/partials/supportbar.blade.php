                    ...
                    <div class="left-content">
                        <ul class="social-icons">
                            @foreach ($all_social_item as $data)
                                <li><a href="{{ $data->url }}" rel="canonical"><i class="{{ $data->icon }}"></i></a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    <div class="right-content">
                        <ul>
                            @if (auth()->check())
                                ...
                                @endphp
                                <li class="login-register"><a href="{{ $route }}">{{ __('Dashboard') }}</a>
                                    <span>/</span>
                            ...
                            @else
                                <li class="login-register"><a href="{{ route('user.login') }}">{{ __('Login') }}</a>
                                    <span>/</span> <a href="{{ route('user.register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                                ...
                                <li>
                                    ...
                                    <div class="btn-wrapper">
                                        <a href="{{ $custom_url }}" rel="canonical"
                                            @if (!empty(get_static_option('navbar_button_custom_url_status'))) target="_blank" @endif
                                            class="boxed-btn reverse-color">{{ get_static_option('navbar_' . $user_select_lang_slug . '_button_text') }}</a>
                                    </div>
                                </li>
                            @endif
                        </ul>
