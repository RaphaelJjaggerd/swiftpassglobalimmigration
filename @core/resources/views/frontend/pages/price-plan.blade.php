...
@section('page-meta-data')
    ...
    {!! render_og_meta_image_by_attachment_id(
        get_static_option('price_plan_page_' . $user_select_lang_slug . '_meta_image'),
    ) !!}
@endsection
@section('content')
    @php $a = 1; @endphp
    @foreach ($all_price_plan as $key => $price_plan)
        <section
            class="pricing-plan-area @if ($a % 2 == 0) bg-liteblue @endif price-inner padding-bottom-120 padding-top-110">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="price-plan-slider global-carousel-init" data-loop="true" data-desktopitem="3"
                            data-mobileitem="1" data-tabletitem="2" data-nav="true" data-autoplay="true" data-margin="30">
                            @foreach ($price_plan as $data)
                                <div
                                    class="single-price-plan-01 @if ($a % 2 != 0) bg-lightwhite @endif  @if (!empty($data->highlight)) style-02 active @endif">
