            ...
            <form action="{{ route('admin.appointment.update') }}" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    <label for="appointment_dates">{{ __('Appointment Dates') }}</label>
                    <input type="text" id="appointment_dates" name="appointment_dates" class="form-control" placeholder="{{ __('Select Appointment Dates') }}">
                  </div>
                  <div class="form-group">
