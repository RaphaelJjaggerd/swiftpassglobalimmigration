    ...
    <div class="main-content-inner">
                ...
                <div class="row">
                    ...
                    {{-- @if (check_page_permission_by_string('Events Manage') && !empty(get_static_option('events_module_status')))
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark mb-3">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.event.attendance.logs') }}" class="add-new"><i
                                            class="ti-eye"></i></a>
                                    <div class="icon">
                    ...
                    {{-- @if (check_page_permission_by_string('Donations Manage') && !empty(get_static_option('donations_module_status')))
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark  mb-3">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.donations.payment.logs') }}" class="add-new"><i
                                            class="ti-eye"></i></a>
                                    <div class="icon">
                                        <i class="ti-money"></i>
                                    </div>
                    ...
                    @if (check_page_permission_by_string('Products Manage') && !empty(get_static_option('product_module_status')))
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark  mb-3">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.products.order.logs') }}" class="add-new"><i
                                            class="ti-eye"></i></a>
                                    <div class="icon">
                    ...
                    @if (check_page_permission_by_string('Price Plan'))
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card text-dark  mb-3">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.price.plan.new') }}" class="add-new"><i
                                            class="ti-plus"></i></a>
                                    <div class="icon">
                    ...
                    {{-- @if (!empty(get_static_option('course_module_status')))
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.courses.enroll.all') }}" class="add-new"><i
                                            class="ti-eye"></i></a>
                                    <div class="icon">
                                        <i class="ti-user"></i>
                                    </div>
                    ...
                    @if (!empty(get_static_option('appointment_module_status')))
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.appointment.new') }}" class="add-new"><i
                                            class="ti-plus"></i></a>
                                    <div class="icon">
                                        <i class="ti-calendar"></i>
                                    </div>
                        ...
                        <div class="col-md-3 mt-md-5 mb-3">
                            <div class="card">
                                <div class="dsh-box-style">
                                    <a href="{{ route('admin.appointment.booking.all') }}" class="add-new"><i
                                            class="ti-eye"></i></a>
                                    <div class="icon">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card margin-top-40">
                    <div class="smart-card">
                        <h4 class="title">{{ __('Recent Appointments ') }}</h4>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                <thead>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        @foreach ($event_attendance_recent_order as $data)
                                            <tr>
                                                <td>#{{ $data->id }}</td>
                                                <td>{{ amount_with_currency_symbol((int) $data->event_cost * $data->quantity) }}
                                                </td>
                                                <td>
                                                    @php $pay_status = $data->payment_status; @endphp
                                                    @if ($pay_status == 'complete')
