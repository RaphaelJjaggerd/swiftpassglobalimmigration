...
@endsection
@section('site-title')
    {{__('All Interview and Simulation Stage Orders')}}
@endsection
@section('content')
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <x-flash-msg/>
                                    <x-error-msg/>
                                    <h4 class="header-title">{{__('All Interview and Simulation Stage Orders')}}</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="order_status" class="form-control" id="order_status">
                                <option value="documentation_and_review">{{__('Documentation & Review')}}</option>
                                <option value="application">{{__('Appication')}}</option>
                                <option value="review_and_submission">{{__('Review & Submission')}}</option>
                                <option value="interviews_and_simulation">{{__('Interviews & Simulation')}}</option>
                                <option value="review_and_submission">{{__('Review & Submission')}}</option>
