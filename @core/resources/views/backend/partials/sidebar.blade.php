        ...
        <ul class="metismenu" id="menu">
          ...
          @if (check_page_permission('admin_manage'))
            <li class="main_dropdown
              ...
              <ul class="collapse">
                ...
                <li class="{{ active_menu('admin-home/admin/all/role') }}"><a href="{{ route('admin.all.user.role') }}">{{ __('All Admin Role') }}</a></li>
              </ul>
            </li>
          @endif
          ...
          @if (check_page_permission_by_string('Users Manage'))
            <li class="main_dropdown
              ...
              <ul class="collapse">
                <li class="{{ active_menu('admin-home/frontend/user/all') }}"><a href="{{ route('admin.all.frontend.user') }}">{{ __('All Users') }}</a></li>
          ...
          @if (check_page_permission_by_string('Package Orders Manage'))
            <li class="main_dropdown @if (request()->is(['admin-home/payment-logs/report', 'admin-home/payment-logs', 'admin-home/package/*'])) active @endif
              ...
              <ul class="collapse">
                ...
                <li class="{{ active_menu('admin-home/package/order-manage/all') }}"><a href="{{ route('admin.package.order.manage.all') }}">{{ __('All Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/pending') }}"><a href="{{ route('admin.package.order.manage.pending') }}">{{ __('Pending Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/in-progress') }}">
                  <a href="{{ route('admin.package.order.manage.in.progress') }}">{{ __('In Progress Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/application') }}">
                  <a href="{{ route('admin.package.order.manage.application') }}">{{ __('Application Stage Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/approved') }}">
                  <a href="{{ route('admin.package.order.manage.approved') }}">{{ __('Approved Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/denied') }}">
                  <a href="{{ route('admin.package.order.manage.denied') }}">{{ __('Denied Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/documentation-and-review') }}">
                  <a href="{{ route('admin.package.order.manage.documentation.and.review') }}">{{ __('Documentation And Review') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/interviews-and-simulation') }}">
                  <a href="{{ route('admin.package.order.manage.interview.and.simulation') }}">{{ __('Interviews And Simulation') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/review-and-submission') }}">
                  <a href="{{ route('admin.package.order.manage.review.and.submission') }}">{{ __('Review And Submission') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/completed') }}"><a href="{{ route('admin.package.order.manage.completed') }}">{{ __('Completed Order') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/success-page') }}">
                  <a href="{{ route('admin.package.order.success.page') }}">{{ __('Success Order Page') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/cancel-page') }}">
                  <a href="{{ route('admin.package.order.cancel.page') }}">{{ __('Cancel Order Page') }}</a>
                </li>
                ...
                <li class="{{ active_menu('admin-home/payment-logs') }}"><a href="{{ route('admin.payment.logs') }}">{{ __('All Payment Logs') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/payment-logs/report') }}"><a href="{{ route('admin.payment.report') }}">{{ __('Payment Report') }}</a>
                </li>
                <li class="{{ active_menu('admin-home/package/order-manage/settings') }}"><a href="{{ route('admin.package.settings') }}">{{ __('Settings') }}</a>
                </li>
              </ul>
            </li>
          @endif
          ...
          @if (check_page_permission_by_string('Appointment Manage') && !empty(get_static_option('appointment_module_status')))
            <li class="main_dropdown @if (request()->is('admin-home/appointment/*')) active @endif ">
              <a href="javascript:void(0)" aria-expanded="true"> <i class="ti-time"></i>
                <span>{{ __('Appointment Manage') }}</span> </a>
              <ul class="collapse">
          ...
          {{-- <li
                        ...
                        <ul class="collapse">
                            <li
                                ...
                                <a href="{{ route('admin.advertisement') }}">{{ __('All Advertisements') }}</a></li>
          ...
          @if (check_page_permission_by_string('Price Plan'))
            <li class="main_dropdown {{ active_menu('admin-home/price-plan') }}
              ...
              <ul class="collapse">
                ...
                {{-- <li class="{{ active_menu('admin-home/price-plan/coupon') }}">
                                    <a href="{{ route('admin.price.plan.coupon.all') }}">{{ __('Coupons') }}</a>
                                </li> --}}
                <li class="{{ active_menu('admin-home/price-plan/coupon') }}">
          ...
          <li class="main_dropdown
            ...
            <ul class="collapse ">
              @if (check_page_permission_by_string('Home Page Manage'))
                <li class="main_dropdown
                                @if (request()->is(['admin-home/home-' . $home_page_variant . '/*', 'admin-home/home-page-' . $home_page_variant . '/*', 'admin-home/home-page-01/*', 'admin-home/header', 'admin-home/keyfeatures', 'admin-home/page-builder/home-page'])) active @endif
                                ">
                  <a href="javascript:void(0)" aria-expanded="true">
                    {{ __('Home Page Manage') }}
                  </a>
                  <ul class="collapse">
                    ...
                    @if (empty(get_static_option('home_page_page_builder_status')))
                      @if (in_array($home_page_variant, ['01', '02', '03', '04']))
                        ...
                        <li class="{{ active_menu('admin-home/home-page-01/about-us') }}"><a href="{{ route('admin.homeone.about.us') }}">{{ __('About Us Area') }}</a>
                        </li>
                        <li class="{{ active_menu('admin-home/home-page-01/service-area') }}">
                          <a href="{{ route('admin.homeone.service.area') }}">{{ __('Service Area') }}</a>
                        </li>
                        @if ($home_page_variant != '03')
                          <li class="{{ active_menu('admin-home/home-page-01/quality-area') }}">
                            <a href="{{ route('admin.homeone.quality.area') }}">{{ __('Quality Area') }}</a>
                          </li>
                        @endif
                        <li class="{{ active_menu('admin-home/home-page-01/case-study-area') }}">
                          <a href="{{ route('admin.homeone.case.study.area') }}">{{ __('Case Study Area') }}</a>
                        </li>
                        @if ($home_page_variant == '03')
                          <li class="{{ active_menu('admin-home/home-page-01/cta-area') }}">
                            <a href="{{ route('admin.homeone.cta.area') }}">{{ __('Call To Action Area') }}</a>
                          </li>
                        @endif
                        <li class="{{ active_menu('admin-home/home-page-01/testimonial') }}">
                          <a href="{{ route('admin.homeone.testimonial') }}">{{ __('Testimonial Area') }}</a>
                        </li>
                        <li class="{{ active_menu('admin-home/home-page-01/price-plan') }}">
                          <a href="{{ route('admin.homeone.price.plan') }}">{{ __('Price Plan Area') }}</a>
                        </li>
                        <li class="{{ active_menu('admin-home/home-page-01/contact-area') }}">

                          <a href="{{ route('admin.homeone.contact.area') }}">{{ __('Contact Area') }}</a>
                        </li>
                        ...
                        @if (in_array($home_page_variant, ['04', '02']))
                          <li class="{{ active_menu('admin-home/home-page-01/team-member') }}">
                            <a href="{{ route('admin.homeone.team.member') }}">{{ __('Team Member Area') }}</a>
                          </li>
                        @endif
                        @if (in_array($home_page_variant, ['03', '02']))
                          <li class="{{ active_menu('admin-home/home-page-01/brand-logos') }}">
                            <a href="{{ route('admin.homeone.brand.logos') }}">{{ __('Brands Logos Area') }}</a>
                          </li>
                        @endif
                      @endif
                ...
                <li class="main_dropdown @if (request()->is('admin-home/about-page/*') || request()->is('admin-home/page-builder/about-page')) active @endif ">
                  ...
                  <ul class="collapse">
                    @if (empty(get_static_option('about_page_page_builder_status')))
                      <li class="{{ active_menu('admin-home/about-page/about-us') }}"><a href="{{ route('admin.about.page.about') }}">{{ __('About Us Section') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/about-page/global-network') }}"><a href="{{ route('admin.about.global.network') }}">{{ __('Global Network Section') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/about-page/experience') }}"><a href="{{ route('admin.about.experience') }}">{{ __('Experience Section') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/about-page/team-member') }}"><a href="{{ route('admin.about.team.member') }}">{{ __('Team Member Section') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/about-page/testimonial') }}"><a href="{{ route('admin.about.testimonial') }}">{{ __('Testimonial Section') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/keyfeatures') }}">
                        <a href="{{ route('admin.keyfeatures') }}">{{ __('Key Features') }}</a>
                      </li>
                      <li class="{{ active_menu('admin-home/about-page/section-manage') }}"><a href="{{ route('admin.about.page.section.manage') }}">{{ __('Section Manage') }}</a>
                      </li>
                    @endif
          ...
          <li class="main_dropdown
                    @if (request()->is(['admin-home/form-builder/*', 'admin-home/email-template/*', 'admin-home/popup-builder/*', 'admin-home/widgets/*', 'admin-home/widgets', 'admin-home/menu-edit/*', 'admin-home/media-upload/page', 'admin-home/menu', 'admin-home/appearance-setting/*'])) active @endif
                    ">
            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-settings"></i>
            ...
            <ul class="collapse ">
              ...
              @if (check_page_permission_by_string('Widgets Manage'))
                <li class="main_dropdown
                  ...
                  <a href="javascript:void(0)" aria-expanded="true">
                    {{ __('Widgets Manage') }}</a>
                  <ul class="collapse">
                    <li class="{{ active_menu('admin-home/widgets') }}"><a href="{{ route('admin.widgets') }}">{{ __('All Widgets') }}</a>
                    </li>
                  </ul>
                </li>
              @endif
              @if (check_page_permission_by_string('Popup Builder'))
                <li class="main_dropdown @if (request()->is('admin-home/popup-builder/*')) active @endif">
                  ...
                  <ul class="collapse">
                    <li class="{{ active_menu('admin-home/popup-builder/all') }}"><a href="{{ route('admin.popup.builder.all') }}">{{ __('All Popup') }}</a>
                    </li>
                    <li class="{{ active_menu('admin-home/popup-builder/new') }}"><a href="{{ route('admin.popup.builder.new') }}">{{ __('New Popup') }}</a>
                    </li>
                  </ul>
                </li>
              @endif
            ...
            <li class="main_dropdown @if (request()->is('admin-home/general-settings/*')) active @endif">
              ...
              <ul class="collapse ">
                ...
                @if (!empty(get_static_option('site_payment_gateway')))
                  <li class="{{ active_menu('admin-home/general-settings/payment-settings') }}"><a href="{{ route('admin.general.payment.settings') }}">{{ __('Payment Gateway Settings') }}</a>
                  </li>
                @endif
