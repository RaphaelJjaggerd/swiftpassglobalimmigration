...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'moduleCheck:appointment_module_status']], function () {
  ...
  Route::get('/appointment-booking-date-check', 'Frontend\AppointmentController@appointment_booking_date_check')->name('frontend.appointment.booking.date.check');
});
...
Route::group(['middleware' => ['setlang:frontend', 'globalVariable', 'maintains_mode', 'HtmlMinifier']], function () {
  ...
  Route::post('/order-coupon', 'FrontendController@apply_order_coupon')->name('frontend.course.apply.order.coupon');
