...
Route::prefix('admin-home')->middleware(['setlang:backend'])->group(function () {
  ...
  Route::prefix('package')->middleware(['adminPermissionCheck:Package Orders Manage'])->group(function () {
    ...
    Route::group(['prefix' => 'order-manage'], function () {
      ...
      Route::get('/application', 'OrderManageController@application')->name('admin.package.order.manage.application');
      Route::get('/approved', 'OrderManageController@approved')->name('admin.package.order.manage.approved');
      Route::get('/denied', 'OrderManageController@denied')->name('admin.package.order.manage.denied');
      Route::get('/documentation-and-review', 'OrderManageController@documentation_and_review')->name('admin.package.order.manage.documentation.and.review');
      Route::get('/interviews-and-simulation', 'OrderManageController@interviews_and_simulation')->name('admin.package.order.manage.interview.and.simulation');
      Route::get('/review-and-submission', 'OrderManageController@review_and_submission')->name('admin.package.order.manage.review.and.submission');
  ...
  /*==============================================
     ...
     ==============================================*/
  Route::group(['prefix' => 'price-plan', 'middleware' => ['auth:admin', 'moduleCheck:course_module_status', 'adminPermissionCheck:Courses Manage']], function () {
...
==============================================*/
  ...
  Route::prefix('price-plan')->middleware(['adminPermissionCheck:Price Plan'])->group(function () {
    ...
    // Route::group(['prefix' => 'coupon'], function () {
    //   Route::get('/', 'PricePlanCouponController@all')->name('admin.price.plan.coupon.all');
    //   Route::post('/new', 'PricePlanCouponController@new')->name('admin.price.plan.coupon.store');
    //   Route::post('/update', 'PricePlanCouponController@update')->name('admin.price.plan.coupon.update');
    //   Route::post('/delete/{id}', 'PricePlanCouponController@delete')->name('admin.price.plan.coupon.delete');
    //   Route::post('/bulk-action', 'PricePlanCouponController@bulk_action')->name('admin.price.plan.coupon.bulk.action');
    // });
  });
