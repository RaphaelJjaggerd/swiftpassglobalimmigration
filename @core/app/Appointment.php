...
class Appointment extends Model {
  ...
  protected $fillable = ['image', 'categories_id', 'booking_time_ids', 'status', 'appointment_status', 'max_appointment', 'price', 'appointment_type', 'discounted_amount'];
  ...
  public function bookingDates() {
    return $this->hasMany(AppointmentBookingDate::class);
  }
