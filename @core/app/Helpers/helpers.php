...
function half_amount_with_currency_symbol($amount, $text = false) {
  $symbol
    = site_currency_symbol($text);
  return $symbol . $amount / 2;
}
...
function get_amount_in_kes($amount, $currency) {
  $output = 0;
  $all_currency = [
    'USD' => '$', 'EUR' => '€', 'INR' => '₹', 'IDR' => 'Rp', 'AUD' => 'A$', 'SGD' => 'S$', 'JPY' => '¥', 'GBP' => '£', 'MYR' => 'RM', 'PHP' => '₱', 'THB' => '฿', 'KRW' => '₩', 'NGN' => '₦', 'GHS' => 'GH₵', 'BRL' => 'R$',
    'BIF' => 'FBu', 'CAD' => 'C$', 'CDF' => 'FC', 'CVE' => 'Esc', 'GHP' => 'GH₵', 'GMD' => 'D', 'GNF' => 'FG', 'KES' => 'K', 'LRD' => 'L$', 'MWK' => 'MK', 'MZN' => 'MT', 'RWF' => 'R₣', 'SLL' => 'Le', 'STD' => 'Db', 'TZS' => 'TSh', 'UGX' => 'USh', 'XAF' => 'FCFA', 'XOF' => 'CFA', 'ZMK' => 'ZK', 'ZMW' => 'ZK', 'ZWD' => 'Z$',
  ...
  foreach ($all_currency as $cur => $symbol) {
    ...
    if ($cur == $currency) {
      $exchange_rate = get_static_option('site_' . strtolower($cur) . '_to_kes_exchange_rate');
      $output = $amount * $exchange_rate;
    }
  }
...
function get_charge_amount($amount, $gateway, $payment_type) {
  $output = 0;
  if ($gateway == 'paypal') {
